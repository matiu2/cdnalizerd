...
/// Takes a number, and outputs it hexadecimal representation
...
{
    std::string utf8;
    std::getline(cin, utf8);
    cout << utf82json(utf8) << endl;
