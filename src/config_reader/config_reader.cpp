...
struct ConfigReader {
  ...
  void processPathLine(const std::string &line) {
    ...
    start = std::find_if(start, line.end(),
                         [](char x) { return (x != ' ') && (x != '\t'); });
  ...
  void processSettingLine(const std::string &line) {
    ...
    if (variable == "username")
      ...
      if ((value == "true") || (value == "on"))
        ...
        throw ConfigError(
            std::string("snet should be true/false or on/off. Not ") + value);
      ...
      if ((value == "true") || (value == "on"))
        ...
        throw ConfigError(
            std::string("move should be true/false or on/off. Not ") + value);
    } else {
      std::stringstream msg;
      msg << "Unkown setting '" << variable << "' on line " << linenum
          << " of config file";
